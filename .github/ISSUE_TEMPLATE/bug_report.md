...
1. **Build-time issue**: you get either a compile-time error or warning while building **include-tidy**.
2. **Run-time issue**: given particular input, **include-tidy** either gives incorrect output or crashes.
...
**What was the input given to include-tidy?**

(Please include **_only_** the input necessary to elicit the bug.)

**What output did you expect to be given by include-tidy?**

**What output was actually given by include-tidy?**

**If include-tidy crashed, what was the crash message?**
